...
open_weather_map_API_key = "fc1480c1f8dcc42aac7e3894c5db671a"
...
def thread_for_weather_maps(locations):
 ...
 #           folium.TileLayer('cartodbpositron').add_to(maps)
            ...
            maps.save("C://Users//kalpb//OneDrive//Desktop//weather_forcast//weather_map_data//"+city+"_"+last_timestamp_date.replace(":","_")+".html")
...
#        folium.TileLayer('cartodbdark_matter').add_to(maps)
        ...
        legend_html =   '''
                ...
                ''' %(icon_url,weather)
        maps.get_root().html.add_child(folium.Element(legend_html))        
        maps.save("C://Users//kalpb//OneDrive//Desktop//weather_forcast//weather_map_data//Latest_weather_data//"+city+"_"+last_timestamp_date.replace(":","_")+"_latest_weather.html")
...
def thread_for_plotting_forecast_data():
    ...
    for city in city_names:
        ...
        sns.lineplot(date_times)
        plt.savefig("C://Users//kalpb//OneDrive//Desktop//weather_forcast//weather_map_data//Plots//"+city+".png")
        plt.close()
